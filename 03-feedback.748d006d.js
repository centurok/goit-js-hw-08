...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector(".feedback-form"),a="feedback-form-state";let l={};const o=e=>{e.preventDefault(),""===r.email.value||""===r.message.value?(e.currentTarget.reset(),alert("All fields are required!")):(console.log(l),e.currentTarget.reset(),localStorage.removeItem(a),l={})},s=e=>{l[e.target.name]=e.target.value,localStorage.setItem(a,JSON.stringify(l))},n=()=>{const e=JSON.parse(localStorage.getItem(a));for(const t in e)t&&(r[t].value=n[t],l=e)};r.addEventListener("submit",o),r.addEventListener("input",(0,e.default)(s,500)),n();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.748d006d.js.map